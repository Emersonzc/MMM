...
parser.add_argument('--savename', default='MMM_batch_6_PN_4', type=str,
...
parser.add_argument('--data-path', default='/data/yxb/datasets/ReIDData/SYSU-MM01/', type=str, help='path to dataset')
...
pseudo_labels_rgb, pseudo_labels_ir=multi_memory_learning_matching(data_path)
